...
enum class Screen {
    ONBOARDING, HOME, HOW_TO_PLAY, SELECT_MODE, CREATE_GAME, JOIN_GAME, LOBBY, GAME_START_TRANSITION, GAME, VOTE_TRANSITION, REVIEW, RESULTS_TRANSITION, RESULTS, HISTORY, SETTINGS, STATS, SOLO_START_TRANSITION, SOLO_GAME, SOLO_RESULTS, SOLO_LEADERBOARD, SHOP, PROFILE_SETUP, ACCOUNT, FRIENDS, MP_LEADERBOARD, PROFILE, ACTIVITY_FEED
}
